...
function InfoSection({trip}) {
  ...
  return (
    <div>
      <img src={photoUrl?photoUrl:"https://aitrip.tubeguruji.com/placeholder.jpg"} className='h-[340px] w-full object-con=ver rounded-xl' alt="https://www.gstatic.com/mobilesdk/230918_mobilesdk/all_projects_right_image.png" />
